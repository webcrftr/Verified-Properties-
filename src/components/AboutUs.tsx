      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 sm:mb-24 animate-fade-in">
          ...
          <h1 className="text-4xl sm:text-5xl font-light font-serif text-white tracking-tight">
            About <span className="font-serif italic font-bold text-[#F0D36B]">Verified Properties</span>
          </h1>
          <p className="text-[#D1D5DB] text-sm max-w-xl mx-auto mt-4 font-sans uppercase tracking-widest leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch mb-24">
          ...
          <div className="lg:col-span-5 relative flex flex-col justify-between">
            <div className="absolute inset-0 bg-[#F0D36B]/5 pointer-events-none"></div>
            
            <div className="relative bg-[#1F2937]/85 backdrop-blur-md border border-[#374151] p-8 sm:p-10 backdrop-blur-md h-full flex flex-col justify-between shadow-xl">
              <div>
                <span className="text-[#F0D36B] text-[10px] font-mono tracking-widest uppercase block mb-3">
                  ESTABLISHED CONTROLLER
                </span>
                <h3 className="text-3xl font-light font-serif text-white mb-6">
                  Mansi <span className="italic font-bold text-[#F0D36B]">Gaikwad</span>
                </h3>
                <p className="text-[#D1D5DB] text-xs sm:text-sm leading-relaxed mb-6 font-sans">
              ...
              <div className="border-t border-[#374151] pt-6 mt-6 flex items-center gap-4">
                <div className="bg-[#F0D36B]/10 p-3 text-[#F0D36B] border border-[#D9B84C]/30">
                  <Shield className="h-5 w-5 stroke-[2]" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider">Licensed Agent No</h4>
                  <p className="text-[11px] font-mono text-[#F0D36B]">{BUSINESS_DETAILS.reraNo}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
            <h2 className="text-2xl sm:text-3xl font-light font-serif text-white leading-tight">
              An Advisory Formed on <span className="font-serif italic font-semibold text-[#F0D36B]">Real Valuations & Safety</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          {/* Mission Card */}
          <div className="p-8 sm:p-10 bg-[#1F2937]/80 backdrop-blur-md border border-[#374151] relative overflow-hidden group hover:border-[#D9B84C]/25 transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="p-3 bg-[#111827] text-[#F0D36B] border border-[#374151] w-fit mb-6">
                <Target className="h-6 w-6" />
              </div>
              <h3 className="text-xl font-bold uppercase tracking-wider text-white mb-4">Our Sacred Mission</h3>
              <p className="text-xs sm:text-sm text-[#D1D5DB] leading-relaxed font-sans mb-6">
            ...
            <div className="text-[10px] font-mono text-[#F0D36B] tracking-widest uppercase">Safe Handover Priorities</div>
          </div>
          ...
          <div className="p-8 sm:p-10 bg-[#1F2937]/80 backdrop-blur-md border border-[#374151] relative overflow-hidden group hover:border-[#D9B84C]/25 transition-all duration-300 flex flex-col justify-between">
            ...
            <div className="text-[10px] font-mono text-[#F0D36B] tracking-widest uppercase">Zero-Litigation Horizons</div>
          </div>

        </div>

        {/* Core Values / Why Customers Trust Us Info */}
        <div className="p-8 sm:p-12 bg-white/5 border border-[#374151]/50 text-center max-w-4xl mx-auto space-y-6">
          <div className="p-3 bg-[#111827] border border-[#374151] text-[#F0D36B] w-fit mx-auto">
            <HelpingHand className="h-6 w-6" />
          </div>
          <h3 className="text-2xl font-light font-serif text-white">
            Driven by <span className="font-serif italic font-semibold text-[#F0D36B]">Fiduciary Responsibility</span>
          </h3>
          <p className="text-xs sm:text-sm text-[#D1D5DB] leading-relaxed max-w-2xl mx-auto font-sans">
          ...
          <div className="pt-2">
            <button
              ...
              className="px-6 py-3 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 font-extrabold text-xs uppercase tracking-widest transition-colors cursor-pointer"
            >
