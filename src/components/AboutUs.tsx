      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 sm:mb-24 animate-fade-in">
          ...
          <h1 className="text-4xl sm:text-5xl font-light font-serif text-white tracking-tight">
            About <span className="font-serif italic font-bold text-[#D4AF37]">Verified Properties</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch mb-24">
          ...
          <div className="lg:col-span-5 relative flex flex-col justify-between">
            ...
            <div className="relative bg-[#0a1122]/90 border border-white/10 p-8 sm:p-10 backdrop-blur-md h-full flex flex-col justify-between shadow-xl">
              <div>
                <span className="text-[#D4AF37] text-[10px] font-mono tracking-widest uppercase block mb-3">
                  ESTABLISHED CONTROLLER
                </span>
                <h3 className="text-3xl font-light font-serif text-white mb-6">
                  Mansi <span className="italic font-bold text-[#D4AF37]">Gaikwad</span>
                </h3>
              ...
              <div className="border-t border-white/10 pt-6 mt-6 flex items-center gap-4">
                <div className="bg-[#D4AF37]/10 p-3 text-[#D4AF37] border border-[#D4AF37]/30">
                  <Shield className="h-5 w-5 stroke-[2]" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider">Licensed Agent No</h4>
                  <p className="text-[11px] font-mono text-[#D4AF37]">{BUSINESS_DETAILS.reraNo}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
            <h2 className="text-2xl sm:text-3xl font-light font-serif text-white leading-tight">
              An Advisory Formed on <span className="font-serif italic font-semibold text-[#D4AF37]">Real Valuations & Safety</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          {/* Mission Card */}
          <div className="p-8 sm:p-10 bg-[#0a1122]/80 border border-white/10 relative overflow-hidden group hover:border-[#D4AF37]/25 transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="p-3 bg-[#050B18] text-[#D4AF37] border border-white/10 w-fit mb-6">
            ...
            <div className="text-[10px] font-mono text-[#D4AF37] tracking-widest uppercase">Safe Handover Priorities</div>
          </div>
          ...
          <div className="p-8 sm:p-10 bg-[#0a1122]/80 border border-white/10 relative overflow-hidden group hover:border-[#D4AF37]/25 transition-all duration-300 flex flex-col justify-between">
            ...
            <div className="text-[10px] font-mono text-[#D4AF37] tracking-widest uppercase">Zero-Litigation Horizons</div>
          </div>
        ...
        <div className="p-8 sm:p-12 bg-white/5 border border-white/5 text-center max-w-4xl mx-auto space-y-6">
          <div className="p-3 bg-[#050B18] border border-white/10 text-[#D4AF37] w-fit mx-auto">
            <HelpingHand className="h-6 w-6" />
          </div>
          <h3 className="text-2xl font-light font-serif text-white">
            Driven by <span className="font-serif italic font-semibold text-[#D4AF37]">Fiduciary Responsibility</span>
          </h3>
