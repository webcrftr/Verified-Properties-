...
export default function PropertiesGrid({ 
  ...
  return (
    <section id="properties" className="py-24 bg-[#111827] text-white border-b border-[#374151]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-light font-serif text-white">
            Our Exclusive <span className="font-serif italic font-bold text-[#F0D36B]">Properties</span>
          </h2>
          <div className="h-[1px] w-24 bg-[#E8C75A] mx-auto mt-6"></div>
          <p className="max-w-xl mx-auto text-xs sm:text-sm text-[#D1D5DB] mt-4 uppercase tracking-wider font-sans">
        ...
        {!isFeaturedOnly && (
          <div className="bg-[#1F2937]/90 backdrop-blur-md p-6 sm:p-8 border border-[#374151] mb-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
              
              {/* Search Input */}
              <div className="md:col-span-2 space-y-2">
                <label className="text-[10px] font-bold uppercase text-[#F0D36B] tracking-[0.15em] block">
                  Search Properties
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-white/5 text-sm text-white font-medium border border-[#374151] focus:border-[#D9B84C] focus:outline-none focus:ring-0 transition-all placeholder-white/30"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-[#374151] text-xs text-[#FFFFFF] font-semibold focus:border-[#D9B84C] focus:outline-none cursor-pointer"
                >
                  <option value="all" className="bg-[#1F2937]/90 backdrop-blur-md">All Types</option>
                  <option value="apartment" className="bg-[#1F2937]/90 backdrop-blur-md">Residentials (Flats)</option>
                  <option value="shop" className="bg-[#1F2937]/90 backdrop-blur-md">Retail Shops</option>
                  <option value="office" className="bg-[#1F2937]/90 backdrop-blur-md">Office Workspaces</option>
                  <option value="commercial" className="bg-[#1F2937]/90 backdrop-blur-md">Commercial Complexes</option>
                  <option value="land" className="bg-[#1F2937]/90 backdrop-blur-md">Land Plots (NA)</option>
                </select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-[#374151] text-xs text-[#FFFFFF] font-semibold focus:border-[#D9B84C] focus:outline-none cursor-pointer"
                >
                  <option value="all" className="bg-[#1F2937]/90 backdrop-blur-md">Buy / Rent (All)</option>
                  <option value="sale" className="bg-[#1F2937]/90 backdrop-blur-md">For Sale</option>
                  <option value="rent" className="bg-[#1F2937]/90 backdrop-blur-md">For Rent</option>
                </select>
              </div>
            ...
            {/* Quick Info Tags */}
            <div className="mt-6 flex flex-wrap items-center gap-2 pt-4 border-t border-[#374151] text-xs text-white/40">
              <span className="font-bold uppercase tracking-wider text-[#F0D36B] mr-2">Showing:</span>
              <span className="px-3 py-1 bg-white/5 text-[#FFFFFF] font-mono text-[11px]">
                {displayedProperties.length} Properties
              </span>
              {selectedType !== 'all' && (
                <span className="px-3 py-1 bg-[#F0D36B]/10 text-[#F0D36B] font-bold text-[11px] uppercase tracking-wider">
        ...
        {isNoExactMatch && (
          <div className="mb-8 p-4 bg-[#F0D36B]/10 border border-[#D9B84C]/35 text-center text-xs sm:text-sm font-semibold uppercase tracking-widest text-[#F0D36B] rounded-lg">
        ...
        {displayedProperties.length === 0 && (
          <div className="text-center py-20 bg-[#1F2937]/90 backdrop-blur-md border border-[#374151] p-8">
            ...
            <p className="text-xs text-[#D1D5DB] mt-2 max-w-sm mx-auto leading-relaxed">
            ...
            <button
              ...
              className="mt-6 px-6 py-2.5 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-xs font-bold uppercase tracking-widest cursor-pointer"
            >
              Reset All Filters
            </button>
          </div>
        ...
        {/* Results Count Label */}
        {!isFeaturedOnly && (
          <div className="mt-8 mb-8 flex items-center justify-between border-b border-[#374151]/50 pb-5">
            <p className="text-[#D1D5DB] text-[11px] sm:text-xs font-sans tracking-[0.16em] uppercase flex items-center gap-2 select-none">
              <span>SHOWING</span>
            ...
            <div className="hidden sm:block text-[10px] font-mono text-[#F0D36B]/80">
          ...
          {(isFeaturedOnly ? displayedProperties.slice(0, 3) : displayedProperties).map((prop) => {
            // High fidelity editorial sub-tags map 
              ...
              return (
                <article
                  key={prop.id}
                  className="bg-[#1F2937]/90 backdrop-blur-md border border-[#374151] overflow-hidden hover:border-[#D9B84C]/50 transition-all duration-300 flex flex-col justify-between group rounded-[18px] shadow-lg"
                >
                  {/* Card Image Banner */}
                  ...
                  <div className="absolute top-4 left-4 z-10 flex flex-col gap-1.5 items-start">
                    <span className="px-3.5 py-1.5 text-[9px] font-black uppercase tracking-widest text-[#111827] bg-[#E8C75A] shadow-lg leading-none">
                    ...
                    <span className="px-2.5 py-1 text-[8px] font-mono font-bold uppercase tracking-wider bg-black/85 text-[#F0D36B] border border-[#D9B84C]/30 shadow-md">
                  ...
                  {prop.id !== 'prop-002' && prop.id !== 'prop-003' && prop.id !== 'prop-004' && prop.id !== 'prop-005' && prop.id !== 'prop-006' && (
                    <div className="absolute bottom-4 right-4 z-10 flex items-center gap-1.5">
                      {prop.reraApproved && prop.reraNo && (
                        <div className="flex items-center gap-1.5 px-3 py-1 bg-[#111827]/90 border border-emerald-500/30 rounded-full text-[9px] font-mono font-semibold tracking-wider text-emerald-400">
                          <span className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse"></span>
                          RERA: {prop.reraNo}
                        </div>
                      )}
                      <div className="p-1 px-1.5 bg-[#111827]/90 border border-[#D9B84C]/45 text-[#F0D36B] shadow-md">
                        <ShieldCheck className="h-3.5 w-3.5 fill-[#E8C75A]/10" />
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex items-center justify-between pb-1">
                      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#F0D36B] font-mono">
                    ...
                    {/* Title */}
                    <h3 className="text-lg font-bold mt-2 text-white line-clamp-1 group-hover:text-[#F0D36B] transition-colors leading-snug tracking-tight uppercase font-sans">
                      {prop.title}
                    </h3>

                    {/* Location Pin */}
                    <div className="flex items-center gap-1.5 text-[#D1D5DB] text-[11px] mt-2.5 font-sans">
                      <MapPin className="h-3.5 w-3.5 text-[#F0D36B] flex-shrink-0" />
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4 text-[10px] font-mono uppercase tracking-wider text-[#D1D5DB]">
                      <div className="py-2 px-3 bg-white/5 border border-[#374151]/50 flex flex-col justify-between items-start">
                      ...
                      <div className="py-2 px-3 bg-white/5 border border-[#374151]/50 flex flex-col justify-between items-start">
                        ...
                        <span className="font-bold text-[#F0D36B]">
                  ...
                  <div className="border-t border-[#374151] pt-4 mt-5 space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        {prop.builder && (
                          <span className="text-[9px] font-bold text-[#F0D36B]/85 block tracking-wider uppercase mb-1">
                        ...
                        <span className="text-base font-bold text-[#F0D36B] tracking-tight">
                          {prop.price}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="py-2.5 border border-[#374151] hover:border-[#D9B84C] text-white hover:text-[#F0D36B] text-[10px] font-bold uppercase tracking-wider transition-colors cursor-pointer bg-transparent outline-none flex items-center justify-center"
                      >
                        View Details
                      </button>
                      ...
                      <button
                        ...
                        className="py-2.5 bg-white/5 border border-[#374151] hover:bg-white/10 text-white text-[10px] font-bold uppercase tracking-wider transition-colors cursor-pointer outline-none flex items-center justify-center"
                      >
                        Enquire Now
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-[10px] font-extrabold uppercase tracking-widest transition-colors cursor-pointer shadow-md flex items-center justify-center gap-1.5 outline-none"
                    >
        ...
        {isFeaturedOnly && (
          <div className="mt-16 text-center">
            <button
              ...
              className="px-8 py-3.5 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-xs font-extrabold uppercase tracking-widest transition-all duration-300 inline-block cursor-pointer shadow-lg outline-none"
            >
      ...
      {activePropertyDetail && (() => {
        ...
        return (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-md flex items-center justify-center p-4">
            <div className="bg-[#1F2937]/90 backdrop-blur-md max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative border border-[#374151] text-white">
              
              {/* Close modal button floating */}
              <button
                onClick={handleCloseDetailModal}
                className="absolute top-4 right-4 z-20 p-2 bg-[#111827] border border-[#374151] text-white hover:bg-[#F5DD87] hover:text-white transition-all cursor-pointer outline-none"
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#1F2937] via-[#1F2937]/30 to-transparent pointer-events-none"></div>
                ...
                {propertyImages.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-4 top-1/2 -translate-y-1/2 p-2 bg-black/60 hover:bg-[#F5DD87] text-white hover:text-white transition-all rounded-full border border-[#374151] outline-none cursor-pointer"
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 -translate-y-1/2 p-2 bg-black/60 hover:bg-[#F5DD87] text-white hover:text-white transition-all rounded-full border border-[#374151] outline-none cursor-pointer"
                    ...
                    <div className="absolute top-4 left-4 bg-black/75 border border-[#374151] px-3 py-1 text-[9px] font-mono uppercase tracking-widest text-[#F0D36B] font-bold">
                ...
                <button
                  ...
                  className="absolute bottom-4 right-4 p-2.5 bg-black/75 hover:bg-[#F5DD87] text-white hover:text-white border border-[#374151] shadow-lg transition-all rounded-full outline-none cursor-pointer"
                ...
                <div className="absolute bottom-6 left-6 right-6 pointer-events-none">
                  <span className="px-3 py-1 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-[9px] font-black uppercase tracking-widest leading-none pointer-events-auto">
                  ...
                  <div className="flex items-center gap-1.5 text-[#FFFFFF] text-xs sm:text-sm mt-2 pointer-events-auto">
                    <MapPin className="h-4 w-4 text-[#F0D36B]" />
              ...
              <div className="p-6 sm:p-8 space-y-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <div className="p-4 bg-white/5 border border-[#374151]/50 flex flex-col justify-between">
                  ...
                  <div className="p-4 bg-white/5 border border-[#D9B84C]/25 bg-[#F0D36B]/5 flex flex-col justify-between">
                    <span className="text-[9px] text-[#F0D36B] uppercase font-bold tracking-widest">Price Quote</span>
                    <span className="text-xs font-bold text-[#F0D36B] mt-1">
                ...
                {propertyImages.length > 1 && (
                  <div className="space-y-3">
                    <div className="flex items-center justify-between border-b border-[#374151]/50 pb-2">
                      <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Interactive Media Gallery ({propertyImages.length} Photos)</h4>
                          ...
                          <button
                            ...
                            className={`aspect-square overflow-hidden border transition-all relative ${
                              activeImageIndex === idx 
                                ? 'border-[#D9B84C] ring-2 ring-[#E8C75A]/35 scale-95' 
                                : 'border-[#374151] hover:border-white/40'
                            }`}
                          >
                            {isVideo ? (
                              <>
                                ...
                                <div className="absolute inset-0 bg-black/45 flex items-center justify-center">
                                  <Play className="h-4 w-4 text-[#F0D36B] fill-[#E8C75A]" />
                                </div>
                              </>
                            ) : (
                              <img
                  ...
                  <div className="p-5 bg-emerald-500/5 border border-emerald-500/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#D1D5DB] mt-1">Verified & compliant with Maharashtra Real Estate Regulatory Authority structures.</p>
                      </div>
                    </div>
                    {activePropertyDetail.reraNo && (
                      <span className="font-mono text-xs font-bold text-[#111827] bg-[#E8C75A] px-3 py-1 uppercase tracking-wider shrink-0">
                        {activePropertyDetail.reraNo}
                      </span>
                    )}
                  </div>
                ...
                <div className="space-y-2">
                  <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em]">Property Description</h4>
                ...
                {activePropertyDetail.id === 'prop-004' && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Available Configurations</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="p-5 bg-white/5 border border-[#374151]/50 hover:border-[#D9B84C]/30 transition-all flex flex-col justify-between">
                        <div>
                          <span className="px-2 py-0.5 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-[8px] font-black uppercase tracking-wider">LAVISH</span>
                          <h5 className="text-lg font-bold text-white mt-2">1 BHK</h5>
                          <p className="text-xs text-[#D1D5DB] mt-1 font-mono">Carpet Area: 440 Sq.Ft.</p>
                        </div>
                        <div className="mt-4 border-t border-[#374151] pt-3">
                          <span className="text-[9px] text-white/40 block">STARTING FROM</span>
                          <span className="text-base font-bold text-[#F0D36B]">₹39.99 Lakhs</span>
                        </div>
                      </div>

                      <div className="p-5 bg-white/5 border border-[#374151]/50 hover:border-[#D9B84C]/30 transition-all flex flex-col justify-between">
                        <div>
                          <span className="px-2 py-0.5 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-[8px] font-black uppercase tracking-wider">LUXURIOUS</span>
                          <h5 className="text-lg font-bold text-white mt-2">2 BHK</h5>
                          <p className="text-xs text-[#D1D5DB] mt-1 font-mono">Carpet Area: 710 Sq.Ft.</p>
                        </div>
                        <div className="mt-4 border-t border-[#374151] pt-3">
                          <span className="text-[9px] text-white/40 block">STARTING FROM</span>
                          <span className="text-base font-bold text-[#F0D36B]">₹62.99 Lakhs</span>
                        </div>
                      </div>

                      <div className="p-5 bg-white/5 border border-dashed border-[#374151] flex flex-col items-center justify-center text-center">
                        <Sparkles className="h-6 w-6 text-[#F0D36B]/60 mb-2 animate-pulse" />
                        <h5 className="text-sm font-semibold text-white uppercase tracking-wider">More Layouts</h5>
                        <p className="text-[11px] text-[#D1D5DB] mt-1">Custom configurations & higher floor preferences available on request.</p>
                        <button
                          onClick={() => {
                            setActivePropertyDetail(null);
                            if (onNavigate) {
                          ...
                          className="mt-3.5 px-3 py-1.5 bg-[#F0D36B]/10 hover:bg-[#E8C75A] text-[#F0D36B] hover:text-[#111827] text-[9px] font-bold uppercase tracking-wider transition-all border border-[#D9B84C]/30 cursor-pointer"
                        >
                ...
                {activePropertyDetail.specialOffer && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <div className="bg-gradient-to-r from-[#E8C75A] via-[#F0D36B] to-[#F5DD87] p-0.5 rounded-[12px] shadow-lg overflow-hidden">
                      <div className="bg-[#111827]/95 p-6 rounded-[11px] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden group">
                        ...
                        <div className="space-y-2 relative z-10">
                          <span className="inline-block px-3 py-1 bg-gradient-to-r from-[#E8C75A] to-[#F5DD87] text-white text-[10px] font-black uppercase tracking-widest rounded-full shadow-inner animate-pulse">
                            {activePropertyDetail.specialOffer.title}
                          </span>
                          <h4 className="text-xl sm:text-2xl font-black font-sans bg-gradient-to-r from-[#E8C75A] via-[#F0D36B] to-[#F5DD87] bg-clip-text text-transparent uppercase tracking-tight">
                        ...
                        <div className="relative z-10 shrink-0">
                          <button
                            ...
                            className="px-6 py-3 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-all duration-300 font-black text-xs uppercase tracking-widest rounded-none border border-[#374151] active:scale-95"
                          >
                            Claim Offer Now
                          </button>
                        </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mt-4">
                      {activePropertyDetail.specialOffer.highlights.map((hl, idx) => (
                        <div key={idx} className="p-3.5 bg-gradient-to-b from-[#E8C75A]/5 to-transparent border border-[#D9B84C]/15 hover:border-[#D9B84C]/45 transition-all flex flex-col justify-center items-center text-center relative overflow-hidden group">
                          <div className="absolute top-0 left-0 w-1.5 h-1.5 bg-[#E8C75A]"></div>
                          <CheckCircle2 className="h-4 w-4 text-[#F0D36B] mb-2" />
                  ...
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {activePropertyDetail.configurations.map((config, index) => (
                        <div key={index} className="p-5 bg-white/5 border border-[#374151]/50 hover:border-[#D9B84C]/35 hover:bg-[#F0D36B]/5 transition-all duration-300 flex flex-col justify-between">
                          <div>
                            <span className="px-2 py-0.5 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-[8px] font-black uppercase tracking-wider">
                            ...
                            <p className="text-xs text-[#D1D5DB] mt-1 font-mono">Carpet Area: {config.area}</p>
                          </div>
                          <div className="mt-4 border-t border-[#374151] pt-3">
                            <span className="text-[9px] text-white/40 block">STARTING FROM</span>
                            <span className="text-base font-bold text-[#F0D36B]">{config.price}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                {activePropertyDetail.id === 'prop-005' && activePropertyDetail.grandClubhouse && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">5-Level Grand Clubhouse</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {activePropertyDetail.grandClubhouse.map((lvl, index) => (
                        <div key={index} className="p-5 bg-[#111827]/60 border border-[#D9B84C]/15 hover:border-[#D9B84C]/35 transition-all flex flex-col justify-between">
                          <div className="flex items-center gap-2.5 pb-2.5 border-b border-[#374151]">
                            <span className="p-1 px-2 bg-[#F0D36B]/15 text-[#F0D36B] text-[9px] font-black uppercase tracking-wider">{lvl.level}</span>
                          </div>
                          <div className="flex flex-wrap gap-2 mt-4">
                            {lvl.items.map((item, itemIdx) => (
                              <span key={itemIdx} className="px-3 py-1 bg-white/5 text-white/90 text-xs font-semibold tracking-wider border border-[#374151]/50">
                                {item}
                              </span>
                            ))}
                          </div>
                ...
                {(activePropertyDetail.id === 'prop-005' || activePropertyDetail.id === 'prop-007' || activePropertyDetail.id === 'prop-008' || activePropertyDetail.id === 'prop-009') && activePropertyDetail.paymentPlans && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Exclusive Payment Plans</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      {activePropertyDetail.paymentPlans.map((plan, index) => (
                        <div key={index} className="p-5 bg-[#111827]/40 border border-[#D9B84C]/20 hover:border-[#D9B84C]/45 transition-all flex flex-col justify-between relative overflow-hidden group">
                          <div className="absolute top-0 right-0 p-2 bg-[#F0D36B]/10 text-[#F0D36B] border-l border-b border-[#374151]/50">
                            <CheckCircle2 className="h-4 w-4" />
                          </div>
                          <div>
                            <h5 className="text-xs font-black text-white uppercase tracking-widest">{plan.title}</h5>
                            <p className="text-sm text-[#F0D36B] font-bold mt-2.5 uppercase tracking-wide">{plan.detail}</p>
                            <p className="text-[11px] text-[#D1D5DB] mt-1 font-sans">{plan.extra}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                {activePropertyDetail.id === 'prop-005' && activePropertyDetail.launchBenefits && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Launch Benefits</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                      {activePropertyDetail.launchBenefits.map((benefit, index) => (
                        <div key={index} className="p-4 bg-white/5 border border-[#374151]/50 hover:border-[#D9B84C]/20 transition-all flex items-center gap-3">
                          <div className="p-1.5 bg-[#F0D36B]/15 text-[#F0D36B]">
                ...
                {activePropertyDetail.id === 'prop-007' && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-[#374151]/50">
                    {/* Schools & Hospitals */}
                    <div className="p-5 bg-white/5 border border-[#374151]/50 space-y-3.5">
                      <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Educational Institutions & Healthcare</h4>
                    ...
                    <div className="p-5 bg-[#F0D36B]/5 border border-[#D9B84C]/20 space-y-3.5">
                      <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Commercial & Parking</h4>
                      <div className="space-y-2.5">
                        <div className="space-y-1">
                          <span className="text-[9px] text-[#F0D36B] uppercase block font-semibold">Commercial Shops</span>
                          <p className="text-xs text-white/90 font-bold">Starting from ₹16,500 per Sq.Ft.</p>
                        </div>
                        <div className="h-px bg-white/5"></div>
                        <div className="space-y-1">
                          <span className="text-[9px] text-[#F0D36B] uppercase block font-semibold">Parking Spaces Available</span>
                ...
                <div className="space-y-4">
                  <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em]">Project Specifications & Details</h4>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {activePropertyDetail.features.map((feature, i) => (
                      <div key={i} className="flex items-center gap-3">
                        <CheckCircle2 className="h-4 w-4 text-[#F0D36B] flex-shrink-0" />
                        <span className="text-xs sm:text-sm font-medium text-[#FFFFFF] uppercase tracking-wider">{feature}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {activePropertyDetail.highlights && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Main Highlights</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                      {activePropertyDetail.highlights.map((highlight, idx) => (
                        <div key={idx} className="flex items-start gap-2.5">
                          <CheckCircle2 className="h-4 w-4 text-[#F0D36B] shrink-0 mt-0.5" />
                ...
                {activePropertyDetail.amenities && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Premium Amenities</h4>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      {activePropertyDetail.amenities.map((amenity, idx) => {
                        ...
                        return (
                          <div 
                            key={idx} 
                            className="p-4 bg-white/5 border border-[#374151]/50 hover:border-[#D9B84C]/30 hover:bg-[#F0D36B]/5 transition-all duration-300 flex flex-col items-center text-center gap-2.5 group"
                          >
                            <div className="p-2.5 bg-[#111827] border border-[#374151] group-hover:border-[#D9B84C]/50 text-[#F0D36B] transition-all">
                ...
                {activePropertyDetail.advantages && (
                  <div className="space-y-4 pt-4 border-t border-[#374151]/50">
                    <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-[0.2em] font-mono">Location Advantages</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {activePropertyDetail.advantages.map((adv, idx) => {
                        ...
                        return (
                          <div 
                            key={idx} 
                            className="p-4 bg-white/5 border border-[#374151]/50 flex items-center gap-3.5 hover:bg-white/[0.07] transition-colors"
                          >
                            <div className="p-2 bg-[#F0D36B]/15 text-[#F0D36B]">
                ...
                {activePropertyDetail.id === 'prop-003' || activePropertyDetail.id === 'prop-004' || activePropertyDetail.id === 'prop-005' || activePropertyDetail.id === 'prop-006' ? (
                  <div className="border border-[#D9B84C]/30 bg-[#1F2937]/80 backdrop-blur-lg p-6 sm:p-8 rounded-[18px] backdrop-blur-md space-y-6 mt-6 select-none relative overflow-hidden">
                    {/* Decorative gold spotlight */}
                    <div className="absolute right-0 top-0 w-32 h-32 bg-[#F0D36B]/10 rounded-full filter blur-2xl pointer-events-none"></div>
                    
                    <div className="text-center sm:text-left space-y-1">
                      <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#F0D36B] font-semibold block">EXQUISITE OPPORTUNITY</span>
                      <h4 className="text-xl sm:text-2xl font-light font-serif text-white">
                        {activePropertyDetail.id === 'prop-003' ? (
                          <>Book Your <span className="font-serif italic font-bold text-[#F0D36B]">Dream Home</span> Today</>
                        ) : activePropertyDetail.id === 'prop-005' ? (
                          <>Live Above the <span className="font-serif italic font-bold text-[#F0D36B]">Ordinary</span></>
                        ) : activePropertyDetail.id === 'prop-006' ? (
                          <>Your Dream Home is <span className="font-serif italic font-bold text-[#F0D36B]">Just ₹501 Away!</span></>
                        ) : (
                          <>Upgrade Your <span className="font-serif italic font-bold text-[#F0D36B]">Lifestyle Today</span></>
                        )}
                      </h4>
                      <p className="text-xs sm:text-sm text-[#D1D5DB] font-sans mt-1">
                        {activePropertyDetail.id === 'prop-003' 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 pt-2">
                      <button
                        ...
                        className="py-3.5 px-4 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-[11px] font-black uppercase tracking-widest transition-all shadow-md flex items-center justify-center gap-2 outline-none cursor-pointer"
                      >
                      ...
                      <a
                        ...
                        className="py-3.5 px-4 bg-[#1F2937]/90 backdrop-blur-md border border-[#374151] hover:bg-white/10 text-white text-[11px] font-black uppercase tracking-widest text-center transition-all flex items-center justify-center gap-2 outline-none cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="py-3.5 px-4 bg-white/5 border border-[#374151] hover:border-[#D9B84C] hover:bg-white/10 text-white text-[11px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 outline-none cursor-pointer"
                      >
                        <Download className="h-4 w-4 text-[#F0D36B]" />
                  ...
                  <div className="border-t border-[#374151] pt-6 space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm font-bold text-[#F0D36B] uppercase tracking-wider mt-0.5">
                        ...
                        {activePropertyDetail.id !== 'prop-007' && activePropertyDetail.id !== 'prop-008' && (
                          <p className="text-xs text-[#D1D5DB]">MahaRERA Reg No: A99000026853</p>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <button
                        ...
                        className="w-full py-3.5 bg-white/5 border border-[#374151] hover:bg-white/10 text-white text-xs font-bold uppercase tracking-widest cursor-pointer text-center transition-colors outline-none"
                      >
                        Enquire Now
                      </button>
                      ...
                      <button
                        ...
                        className="w-full py-3.5 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 text-xs font-black uppercase tracking-widest cursor-pointer text-center transition-colors shadow-md outline-none flex items-center justify-center gap-1.5"
                      >
        ...
        return (
          <div className="fixed inset-0 z-[100] bg-black/98 flex flex-col justify-between p-4 sm:p-6 select-none">
            ...
            <div className="flex items-center justify-between border-b border-[#374151]/50 pb-4">
              <div>
                <span className="text-[10px] font-mono text-[#F0D36B] uppercase tracking-[0.2em] font-bold">PREMIUM GALLERY INSPECTION</span>
                <h4 className="text-base font-sans font-medium text-white uppercase mt-0.5">{activePropertyDetail.title}</h4>
              </div>
              
              <button
                onClick={() => setIsLightboxOpen(false)}
                className="p-2.5 bg-white/5 hover:bg-white/20 border border-[#374151] text-white transition-all cursor-pointer rounded-full outline-none"
            ...
            >
              {isVideoUrl(propertyImages[lightboxImageIndex]) ? (
                <video
                  ...
                  preload="metadata"
                  controls
                  className="max-w-full max-h-[70vh] object-contain shadow-2xl border border-[#374151]/50 animate-fade-in"
                  onError={() => {
                    setFailedVideos((prev) => {
                      const next = new Set(prev);
                ...
                <img
                  ...
                  className="max-w-full max-h-[70vh] object-contain shadow-2xl border border-[#374151]/50"
                  referrerPolicy="no-referrer"
                />
              )}
              ...
              {propertyImages.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-2 sm:left-6 p-3 bg-black/60 hover:bg-[#F5DD87] text-white hover:text-white transition-all rounded-full border border-[#374151] cursor-pointer outline-none"
                  >
                    <ChevronLeft className="h-6 w-6" />
                  </button>
                  <button
                    onClick={() => setLightboxImageIndex((prev) => (prev === propertyImages.length - 1 ? 0 : prev + 1))}
                    className="absolute right-2 sm:right-6 p-3 bg-black/60 hover:bg-[#F5DD87] text-white hover:text-white transition-all rounded-full border border-[#374151] cursor-pointer outline-none"
                  >
            ...
            <div className="border-t border-[#374151]/50 pt-4 space-y-4">
              <div className="flex items-center justify-between text-xs text-white/55 font-mono">
                <span>EXPLORING PROPERTY MEDIA FILES</span>
                <span className="text-[#F0D36B] font-bold">IMAGE {lightboxImageIndex + 1} OF {propertyImages.length}</span>
              </div>
                      ...
                      <button
                        ...
                        className={`h-12 w-16 flex-shrink-0 overflow-hidden border transition-all relative ${
                          lightboxImageIndex === idx 
                            ? 'border-[#D9B84C] scale-105 opacity-100 ring-2 ring-[#E8C75A]/30' 
                            : 'border-[#374151] opacity-50 hover:opacity-80'
                        }`}
                      >
                        {isVideo ? (
                          <>
                            ...
                            />
                            <div className="absolute inset-0 bg-black/45 flex items-center justify-center">
                              <Play className="h-3 w-3 text-[#F0D36B] fill-[#E8C75A]" />
                            </div>
                          </>
                        ) : (
                          <img
