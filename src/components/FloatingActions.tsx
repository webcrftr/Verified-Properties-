  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 sm:bottom-6 right-6 z-40">
        ...
        >
          {/* Custom chat icon */}
          <MessageCircle className="h-7 w-7 fill-white/10 text-[#1E1E1E]" />
          
          {/* Quick interactive tooltip on hover */}
          <span className="absolute right-16 scale-0 group-hover:scale-100 transition-all bg-[#FAFAF8] text-white font-mono uppercase tracking-widest text-[9px] px-3 py-1.5 whitespace-nowrap shadow-md border border-[#E7E1D9] rounded-[18px]">
            Instant Chat 💬
          </span>
        </a>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-45 bg-[#FAFAF8]/95 backdrop-blur-md border-t border-[#E7E1D9] block sm:hidden shadow-3xl px-4 py-3">
        <div className="grid grid-cols-2 gap-3">
          
          {/* Mobile Instant Call Hook */}
          <a
            href={`tel:+91${BUSINESS_DETAILS.phone}`}
            className="flex items-center justify-center gap-2 py-3 px-4 bg-[#F5EFE7] border border-[#E7E1D9] text-white font-bold text-xs uppercase tracking-widest rounded-[18px] active:scale-95 transition-transform"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 py-3 px-4 bg-[#C4514F] text-white hover:bg-[#B13E3B] transition-colors duration-300 font-bold text-xs uppercase tracking-widest rounded-[18px] active:scale-95 transition-transform cursor-pointer"
          >
