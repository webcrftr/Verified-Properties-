    ...
    <>
      ...
      <div className="fixed bottom-20 sm:bottom-6 right-6 z-40">
        ...
        >
          ...
          <span className="absolute right-16 scale-0 group-hover:scale-100 transition-all bg-[#050B18] text-white font-mono uppercase tracking-widest text-[9px] px-3 py-1.5 whitespace-nowrap shadow-md border border-[#F7E7A1]/20 rounded-none">
            Instant Chat 💬
          </span>
        </a>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-45 bg-[#050B18]/95 backdrop-blur-md border-t border-[#F7E7A1]/25 block sm:hidden shadow-3xl px-4 py-3">
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 py-3 px-4 bg-[#F4D35E] text-[#050B18] font-bold text-xs uppercase tracking-widest rounded-none active:scale-95 transition-transform cursor-pointer"
          >
