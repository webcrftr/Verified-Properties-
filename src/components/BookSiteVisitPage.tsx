    ...
    <div className="bg-[#111827] text-white min-h-screen">
      ...
      <div className="relative pt-36 pb-20 bg-[#111827] border-b border-[#374151] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center sm:text-left">
          <span className="text-[10px] font-mono text-[#F0D36B] uppercase tracking-[0.25em] font-bold">Exclusive Site Tours</span>
          <h1 className="text-4xl sm:text-5xl font-light font-serif mt-2 text-white">
            Book <span className="italic font-bold text-[#F0D36B]">Site Visit</span>
          </h1>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-8">
            ...
            <div className="space-y-6">
              ...
              <h3 className="text-2xl font-light font-serif text-white">
                Transit & <span className="italic font-bold text-[#F0D36B]">Advisory Support</span>
              </h3>
              ...
              <div className="grid grid-cols-1 gap-4 pt-2">
                <a
                  ...
                  className="flex items-center justify-center gap-2.5 py-3 px-4 bg-[#E8C75A] text-white hover:bg-[#F5DD87] transition-colors duration-300 font-bold text-xs uppercase tracking-widest hover:bg-white hover:text-black transition-all cursor-pointer shadow-md"
                >
            ...
            {/* Perks Cards Stack */}
            <div className="p-5 bg-[#1F2937]/90 backdrop-blur-md border border-[#374151] space-y-4">
              <h4 className="text-[10px] uppercase font-bold text-[#F0D36B] tracking-widest font-mono">SITE VISIT PRIVILEGES</h4>
            ...
            <div className="p-4 bg-white/5 border border-[#374151] text-[10px] text-[#D1D5DB] leading-relaxed font-mono">
              <span className="text-[#F0D36B] font-bold">📢 AGENT CREDENTIALS:</span> Mansi Gaikwad is a registered MahaRERA advisor (License No: A99000026853). All site bookings are managed with absolute integrity.
            </div>
              ...
              {isSubmitted ? (
                <div className="py-16 text-center space-y-6">
                  ...
                  <p className="text-xs sm:text-sm text-[#D1D5DB] leading-relaxed font-sans max-w-sm mx-auto">
                    Mansi Gaikwad has logged your visit to <strong className="text-[#F0D36B]">{selectedProperty}</strong>. Our driver and dedicated coordinator will call you back to confirm pickup coordinates.
                  </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <h3 className="text-2xl font-light font-serif text-white">
                      Arrange <span className="italic font-bold text-[#F0D36B]">Private Tour</span>
                    </h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 bg-[#111827] text-sm text-white border border-[#374151] focus:border-[#D9B84C] focus:outline-none text-[#FFFFFF] cursor-pointer"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 bg-[#111827] text-xs text-[#FFFFFF] font-medium border border-[#374151] focus:border-[#D9B84C] focus:outline-none cursor-pointer"
                      >
                        <option value="10:00 AM - 12:00 PM" className="bg-[#1F2937]/90 backdrop-blur-md">10:00 AM - 12:00 PM (Morning Slot)</option>
                        <option value="12:00 PM - 02:00 PM" className="bg-[#1F2937]/90 backdrop-blur-md">12:00 PM - 02:00 PM (Mid-day Slot)</option>
                        <option value="02:00 PM - 04:00 PM" className="bg-[#1F2937]/90 backdrop-blur-md">02:00 PM - 04:00 PM (Afternoon Slot)</option>
                        <option value="04:00 PM - 06:00 PM" className="bg-[#1F2937]/90 backdrop-blur-md">04:00 PM - 06:00 PM (Sunset Slot)</option>
                        <option value="06:00 PM - 08:00 PM" className="bg-[#1F2937]/90 backdrop-blur-md">06:00 PM - 08:00 PM (Evening Slot)</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-[#111827] text-xs text-[#FFFFFF] font-medium border border-[#374151] focus:border-[#D9B84C] focus:outline-none cursor-pointer"
                    >
                      <option value="1" className="bg-[#1F2937]/90 backdrop-blur-md">1 Person</option>
                      <option value="2" className="bg-[#1F2937]/90 backdrop-blur-md">2 People (Recommended)</option>
                      <option value="3" className="bg-[#1F2937]/90 backdrop-blur-md">3 People</option>
                      <option value="4" className="bg-[#1F2937]/90 backdrop-blur-md">4 People</option>
                      <option value="5+" className="bg-[#1F2937]/90 backdrop-blur-md">Family Group (5+ People)</option>
                    </select>
                  </div>

                  {/* Pickup Required Checkbox & Location Panel */}
                  <div className="p-4 bg-white/5 border border-[#374151] space-y-3">
                    <label className="flex items-center gap-3 cursor-pointer select-none">
                      <input
                        type="checkbox"
                        checked={pickupRequired}
                        onChange={(e) => setPickupRequired(e.target.checked)}
                        className="h-4.5 w-4.5 border border-[#374151] bg-[#111827] accent-[#E8C75A] cursor-pointer"
                      />
                      <span className="text-xs font-bold uppercase text-[#F0D36B] tracking-wider flex items-center gap-1.5">
                    ...
                    {pickupRequired && (
                      <div className="space-y-1.5 animate-fade-in">
                        <label className="text-[9px] uppercase font-bold text-[#D1D5DB] block tracking-widest">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 bg-[#111827] text-xs text-white border border-[#374151] focus:border-[#D9B84C] focus:outline-none placeholder-white/20"
                        />
                      </div>
                    )}
                  </div>
