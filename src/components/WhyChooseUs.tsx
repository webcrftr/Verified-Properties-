...
export default function WhyChooseUs({ onNavigate }: WhyChooseUsProps) {
  const securitySteps = [
    {
      icon: <Shield className="h-6 w-6 text-[#F4D35E]" />,
    ...
    {
      icon: <ShieldAlert className="h-6 w-6 text-[#F4D35E]" />,
    ...
    {
      icon: <Clock className="h-6 w-6 text-[#F4D35E]" />,
    ...
    {
      icon: <Handshake className="h-6 w-6 text-[#F4D35E]" />,
    ...
    {
      icon: <BadgePercent className="h-6 w-6 text-[#F4D35E]" />,
    ...
    {
      icon: <MapPin className="h-6 w-6 text-[#F4D35E]" />,
    ...
    <div className="py-16 sm:py-24 bg-[#050B18]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16 sm:mb-24">
        ...
        <h1 className="text-4xl sm:text-5xl font-light font-serif text-white tracking-tight">
          Why Choose <span className="font-serif italic font-bold text-[#F4D35E]">Verified Properties</span>?
        </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {securitySteps.map((step, idx) => (
            <div 
              key={idx} 
              className="p-8 bg-[#0a1122]/90 border border-white/10 hover:border-[#FFD54F]/35 transition-all duration-300 flex flex-col justify-between group shadow-lg"
            >
              <div>
                <div className="border-b border-white/10 pb-4 mb-6 flex items-center justify-between">
                  {step.icon}
                  <span className="text-[11px] font-mono text-[#F4D35E] font-semibold">0{idx + 1}</span>
                </div>
                <h3 className="text-lg font-bold text-white uppercase tracking-wider mb-4 leading-snug font-sans group-hover:text-[#FFD54F] transition-colors">
                  {step.title}
                </h3>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {stats.map((stat, sIdx) => (
              <div key={sIdx} className="space-y-1">
                <p className="text-4xl sm:text-5xl font-mono text-[#F4D35E] font-bold">{stat.val}</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-12">
        <div className="p-8 sm:p-12 bg-gradient-to-br from-[#0a1122] to-[#040810] border border-[#F7E7A1]/30 relative overflow-hidden text-center space-y-6">
          <div className="absolute -top-16 -right-16 h-32 w-32 bg-[#F7E7A1]/5 rounded-full blur-2xl"></div>
          
          <span className="px-3.5 py-1.5 bg-[#F7E7A1]/10 border border-[#F7E7A1]/30 text-[#F7E7A1] text-[9px] uppercase tracking-widest font-mono font-bold inline-block">
            MahaRERA Compliant Guarantee
          </span>
          
          <h2 className="text-2xl sm:text-3xl font-light font-serif text-white">
            Looking for a <span className="font-serif italic font-semibold text-[#F4D35E]">Zero-Litigation</span> Property?
          </h2>
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center items-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 bg-[#F4D35E] text-[#050B18] font-bold text-xs uppercase tracking-widest hover:bg-white hover:text-black transition-colors shadow-lg cursor-pointer"
            >
              Request Free Consultation
            </button>
            <button
              onClick={() => onNavigate('/contact')}
              className="w-full sm:w-auto px-6 py-3 border border-white/25 hover:border-[#FFD54F] text-white text-xs font-bold uppercase tracking-widest transition-colors cursor-pointer bg-transparent"
            >
              Contact Agent
            </button>
          </div>
