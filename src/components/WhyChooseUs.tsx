...
export default function WhyChooseUs({ onNavigate }: WhyChooseUsProps) {
  const securitySteps = [
    {
      icon: <Shield className="h-6 w-6 text-[#C4514F]" />,
    ...
    {
      icon: <ShieldAlert className="h-6 w-6 text-[#C4514F]" />,
    ...
    {
      icon: <Clock className="h-6 w-6 text-[#C4514F]" />,
    ...
    {
      icon: <Handshake className="h-6 w-6 text-[#C4514F]" />,
    ...
    {
      icon: <BadgePercent className="h-6 w-6 text-[#C4514F]" />,
    ...
    {
      icon: <MapPin className="h-6 w-6 text-[#C4514F]" />,
    ...
    <div className="py-16 sm:py-24 bg-[#FAFAF8]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16 sm:mb-24">
        ...
        <h1 className="text-4xl sm:text-5xl font-light font-serif text-[#1E1E1E] tracking-tight">
          Why Choose <span className="font-serif italic font-bold text-[#C4514F]">Verified Properties</span>?
        </h1>
        <p className="text-[#5B5B5B] text-sm max-w-2xl mx-auto mt-4 font-sans leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {securitySteps.map((step, idx) => (
            <div 
              key={idx} 
              className="p-8 bg-[#FFFFFF]/85 backdrop-blur-md border border-[#E7E1D9] hover:border-[#C4514F]/35 transition-all duration-300 flex flex-col justify-between group shadow-lg"
            >
              <div>
                <div className="border-b border-[#E7E1D9] pb-4 mb-6 flex items-center justify-between">
                  {step.icon}
                  <span className="text-[11px] font-mono text-[#C4514F] font-semibold">0{idx + 1}</span>
                </div>
                <h3 className="text-lg font-bold text-[#1E1E1E] uppercase tracking-wider mb-4 leading-snug font-sans group-hover:text-[#C4514F] transition-colors">
                  {step.title}
                </h3>
      ...
      <div className="bg-[#FAFAF8] border-y border-[#E7E1D9]/50 py-12 sm:py-16 mb-24 select-none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {stats.map((stat, sIdx) => (
              <div key={sIdx} className="space-y-1">
                <p className="text-4xl sm:text-5xl font-mono text-[#C4514F] font-bold">{stat.val}</p>
                <p className="text-[10px] sm:text-xs font-mono uppercase tracking-widest text-[#5B5B5B]">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-12">
        <div className="p-8 sm:p-12 bg-gradient-to-br from-[#FFFFFF] to-[#FAFAF8] border border-[#C4514F]/30 relative overflow-hidden text-center space-y-6">
          <div className="absolute -top-16 -right-16 h-32 w-32 bg-[#C4514F]/5 rounded-full blur-2xl"></div>
          
          <span className="px-3.5 py-1.5 bg-[#C4514F]/10 border border-[#C4514F]/30 text-[#C4514F] text-[9px] uppercase tracking-widest font-mono font-bold inline-block">
            MahaRERA Compliant Guarantee
          </span>
          
          <h2 className="text-2xl sm:text-3xl font-light font-serif text-[#1E1E1E]">
            Looking for a <span className="font-serif italic font-semibold text-[#C4514F]">Zero-Litigation</span> Property?
          </h2>
          
          <p className="text-xs sm:text-sm text-[#5B5B5B] max-w-xl mx-auto leading-relaxed font-sans">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center items-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 bg-[#C4514F] text-white hover:bg-[#B13E3B] transition-colors duration-300 font-bold text-xs uppercase tracking-widest hover:bg-white hover:text-black transition-colors shadow-lg cursor-pointer"
            >
              Request Free Consultation
            </button>
            <button
              onClick={() => onNavigate('/contact')}
              className="w-full sm:w-auto px-6 py-3 border border-[#E7E1D9] hover:border-[#C4514F] text-[#1E1E1E] text-xs font-bold uppercase tracking-widest transition-colors cursor-pointer bg-transparent"
            >
              Contact Agent
            </button>
          </div>
