...
export const PROPERTIES: Property[] = [
  ...
  {
    id: 'prop-002',
    title: 'Global Arena Splendour',
    type: 'apartment',
    transaction: 'sale',
    price: '₹55 Lakhs',
    numericPriceVal: 5500000,
    priceLabel: '₹55 Lakhs',
    location: 'Global Arena Parkway, Naigaon East, Palghar',
    area: '910 Sq.Ft.',
    bedrooms: 2,
    bathrooms: 2,
    reraApproved: true,
    ...
    description: 'Exclusive and spacious 2BHK units inside Global Arena Parkway. Architecturally rich with majestic floor-to-ceiling windows, imported modular bathroom suites, and premium vitrified tiles. Perfect cross ventilation provides cool breezes year-round, backed by 5-star community amenities including a kids playground and central lawn.',
    features: ['Double Balconies', 'Modular Fitting Sets', 'Intercom Security Hub', 'Designated Car Stall', 'Premium Vitrified Tiles', 'Central Garden Area']
  },
  {
    id: 'prop-003',
